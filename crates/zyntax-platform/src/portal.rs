...
const SHORTCUT_ID: &str = "correct-selection";
const DESCRIPTION: &str = "Correct the selected text with ZyntaxAI";
...
mod tests {
    ...
    #[test]
    fn the_shortcut_has_a_stable_id_and_a_description() {
        assert!(!SHORTCUT_ID.is_empty());

        assert!(DESCRIPTION.contains("ZyntaxAI"));
    }
